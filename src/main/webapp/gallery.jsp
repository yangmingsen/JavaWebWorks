<%@ page import="entity.group.GalleryGroup" %>
<%@ page import="entity.PoPhoto" %>
                         ...
                         %>
                              <div class="col-md-6 col-sm-6">
                                   <div class="gallery-thumb">
                                        <a href="<%=photo.getPhotoAddr()%>" class="image-popup">
                                             <img src="<%=photo.getPhotoAddr()%>" class="img-responsive" alt="Gallery Image">
                                        </a>
                                   </div>
                              </div>
